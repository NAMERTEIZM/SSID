...
<img id="resim" src="layer-3@3x.png">
   ...
   <div id="row2" class="col-12" >
   Web Sayfamızı Sizler için Yeniliyoruz...

   </div>

   <div id="row3" class="col-12" >
  <span id="adres">Mimar Sinan Mah. Mimar Sinan Cd. Toplusoy İş Merkezi,<p></p>
             No:5 D:3, 34782 Çekmeköy/İstanbul </span> 
   </div>
